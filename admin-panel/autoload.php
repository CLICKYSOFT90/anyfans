            ...
            <div class="header-left">
                ...
                <div class="header-logo">
                    <a href="<?php echo $wo['config']['site_url'] ?>">
                        <img class="logo" width="114px" src="<?php echo $wo['config']['theme_url'];?>/img/logo.<?php echo $wo['config']['logo_extension'];?>" alt="logo">
                    </a>
                </div>
            </div>
...
<!--                    <li>-->
<!--                        <a -->
<!--                            --><?php //echo ($page == 'bank-receipts') ? 'class="active"' : ''; ?><!-- -->
<!--                                href="-->
<!--                                --><?php //echo Wo_LoadAdminLinkSettings('bank-receipts'); ?>
...
<!--                            -->
                    ...
                    <li <?php echo ($page == 'manage-artist-pages') || ($page == 'manage-influencer-pages') ? 'class="open"' : ''; ?>>
                        <a href="#">
                            <span class="nav-link-icon">
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a <?php echo ($page == 'manage-artist-pages') ? 'class="active"' : ''; ?> href="<?php echo Wo_LoadAdminLinkSettings('manage-artist-pages'); ?>" data-ajax="?path=manage-artist-pages">Manage Artist/Band</a>
                            </li>
                            <li>
