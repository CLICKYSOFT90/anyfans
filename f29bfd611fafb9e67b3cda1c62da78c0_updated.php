                     ...
                     <?php if ($updated == true) { ?>
                      <div>
                        <div class="empty_state">
                           ...
                           <p>Congratulations, you have successfully updated your site.</p>
                           <br>
    ...
    $.post('?update', {
        ...
        if (queriesLength > count) {
            ...
            $.post('?run_lang', {
              ...
              $('.wo_update_changelog').append('<li><span class="fixed">Finished!</span> ~$ Congratulations! you have successfully updated your site.</li>');
