...
if ($wo['config']['membership_system'] == 1) {
        ...
        if ($wo['user']['is_pro'] != 0 || Wo_IsAdmin()) {
            switch ($page) {
                case 'category-listing':
                    include('sources/category-listing.php');
                    break;
                case 'influencer-rank':
                    include('sources/influencer-rank.php');
                    break;
                case 'artist-rank':
                    include('sources/artist-rank.php');
                    break;
                case 'influncers':
                    include('sources/influncers.php');
                    break;
                case 'artist':
                    include('sources/artist-listing.php');
                    break;
                case 'profile':
                    include('sources/another.php');
                    break;
                case 'another':
                    include('sources/another.php');
                    break;
    ...
    switch ($page) {
        ...
        case 'artist':
            ...
            break;
        case 'redirect':
            include('sources/custom_logout.php');
            break;
        case 'profile':
            include('sources/another.php');
            break;
