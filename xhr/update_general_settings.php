...
//                }
                ...
                if (empty($errors)) {
                    ...
                    if($save == true){
                        ...
                        $Update_data['birthday_do_not_show'] = 0;
                        if (!empty($_POST['birthday_do_not_show']) && !empty($_POST['birthday_do_not_show']) && $_POST['birthday_do_not_show'] == 'on') {
                            $Update_data['birthday_do_not_show'] = 1;
                        }
                        $Update_data['birthday_without_year'] = 0;
                        if (!empty($_POST['birthday_without_year']) && !empty($_POST['birthday_without_year']) && $_POST['birthday_without_year'] == 'on') {
                            $Update_data['birthday_without_year'] = 1;
                        }
                        ...
                        if (Wo_UpdateUserData($_POST['user_id'], $Update_data, $unverify)) {
                            ...
                            $another_profile = Wo_GetUserFromRefEmail($_POST['email']);
                            $Update_data = array(
                                'birthday' => $age_data,
                                'gender' => $gender,
                                'country_id' => $_POST['country'],
                            ...
                            $unverify = true;
                            Wo_UpdateRefUserData($another_profile['user_id'],$Update_data,$unverify);
